...
public class GameMap extends JPanel {
    ...
    private static final int DOT_HUMAN_1 = 3;
    private static final int DOT_HUMAN_2 = 4;
    private static final int DOT_PADDING = 7;
    private static final int STATE_DRAW = 0;
    private static final int STATE_WIN_HUMAN = 1;
    private static final int STATE_WIN_HUMAN_1 = 3;
    private static final int STATE_WIN_HUMAN_2 = 4;
    ...
    private void update(MouseEvent e) {
        ...
        if(gameMode==MODE_VS_AI) {
            ...
            player1Turn(e);
            repaint();
//            System.out.println("Игрок 1 сходил!");
            ...
            player2Turn(e);
            repaint();
//            System.out.println("Игрок 2 сходил!");
            if (gameCheck(DOT_HUMAN_2, STATE_WIN_HUMAN_2)) {
                return;
            }
    ...
    private boolean player1Turn(MouseEvent event) {
        int cellX = event.getX() / cellWidth;
        int cellY = event.getY() / cellHeight;
    ...
    private void showGameOverMessage(Graphics g) {
        ...
        switch (stateGameOver) {
            ...
            case STATE_WIN_HUMAN_1:
                g.drawString("PLAYER 1 WIN", getWidth() / 4, getHeight() / 2);
                break;
            case STATE_WIN_HUMAN_2:
                g.drawString("PLAYER 2 WIN", getWidth() / 4, getHeight() / 2);
                break;
        }
    }
